...
class HospitalsControllerTest < ActionController::TestCase
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post :create, hospital: { address1: @hospital.address1, address2: @hospital.address2, city: @hospital.city, name: @hospital.name, phone1: @hospital.phone1, phone2: @hospital.phone2 }
    end
  ...
  test "should update hospital" do
    patch :update, id: @hospital, hospital: { address1: @hospital.address1, address2: @hospital.address2, city: @hospital.city, name: @hospital.name, phone1: @hospital.phone1, phone2: @hospital.phone2 }
    assert_redirected_to hospital_path(assigns(:hospital))
  end
